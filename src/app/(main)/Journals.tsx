            ...
            >
              ...
              <div className="mt-3 flex justify-start gap-4">
                <div className="flex gap-2">
                  ...
                  <span className="text-sm font-medium text-[#737887] group-hover:!text-white">
                    {item?.date}
                  </span>
                </div>
                <div className="flex gap-2">
              ...
              <div className="text-2xl font-medium text-[#141D38] group-hover:!text-white">
                {item?.desc}
              </div>
              <Link
                href={item?.link ?? "#"}
                className="flex items-center text-sm font-semibold text-[#141D38] group-hover:!text-white"
              >
                Learn More
                <svg
                  width="25"
